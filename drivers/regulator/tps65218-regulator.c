...
/* Added by MYIR, add LS2/LS3 control */
	TPS65218_INFO(6, "LS2", 5000000, 5000000, NULL, NULL),
	TPS65218_INFO(7, "LS3", 5000000, 5000000, NULL, NULL), 


	TPS65218_INFO(8/* MYIR, was 6 */, "LDO1", 900000, 3400000,
		      tps65218_ldo1_dcdc3_vsel_to_uv,
		      tps65218_ldo1_dcdc3_uv_to_vsel),
};
...
/* Added by MYIR, add LS2/LS3 control  */
	TPS65218_OF_MATCH("ti,tps65218-ls2", tps65218_pmic_regs[6]),
	TPS65218_OF_MATCH("ti,tps65218-ls3", tps65218_pmic_regs[7]), 

	TPS65218_OF_MATCH("ti,tps65218-ldo1", tps65218_pmic_regs[8/* MYIR, was 6*/]),
};
...
static int tps65218_pmic_enable(struct regulator_dev *dev)
{
	...
	if (rid < TPS65218_DCDC_1 || rid > TPS65218_LDO_1)
		return -EINVAL;
#if 0
	/* MYIR, set current limit for LS2/LS3 to 500 mA */
	if (rid == TPS65218_LS_2) {
		 tps65218_set_bits(tps, TPS65218_REG_CONFIG2,
                 TPS65218_CONFIG2_LS2ILIM_MASK, 0x02/* 500 mA */,
                 TPS65218_PROTECT_L1);
	} else if (rid == TPS65218_LS_3) {
		 tps65218_set_bits(tps, TPS65218_REG_CONFIG2,
                 TPS65218_CONFIG2_LS3ILIM_MASK, 0x02<<2/* 500 mA */,
                 TPS65218_PROTECT_L1);
	}
#endif
...
/* Operations permitted on LS1/LS2/LS3 */
static struct regulator_ops tps65218_ls_pmic_ops = {
	.is_enabled		= regulator_is_enabled_regmap,
	.enable			= tps65218_pmic_enable,
	.disable		= tps65218_pmic_disable,
};
...
/* MYIR */
	TPS65218_REGULATOR("LS2", TPS65218_LS_2, tps65218_ls_pmic_ops,
			   1, -1, -1, TPS65218_REG_ENABLE2,
			   TPS65218_ENABLE2_LS2_EN, NULL),
	TPS65218_REGULATOR("LS3", TPS65218_LS_3, tps65218_ls_pmic_ops,
			   1, -1, -1, TPS65218_REG_ENABLE2,
			   TPS65218_ENABLE2_LS3_EN, NULL), 
...
static int tps65218_regulator_probe(struct platform_device *pdev)
{
	...
	/* MYIR, LS_2 - vbus0(device mode), LS_3 - vbus1(host mode) 
	if (id == TPS65218_LS_2) {
		printk(KERN_ERR"[MYIR_DBG] disable vbus0 regulator by default(device)!\n");
		tps65218_pmic_disable(rdev);
	} else if (id == TPS65218_LS_3) {
		printk(KERN_ERR"[MYIR_DBG] enable vbus1 regulator by default(host)!\n");
		tps65218_pmic_enable(rdev);
	} */
